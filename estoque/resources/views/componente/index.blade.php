...
<style>
  ...
  <div class="uper">
    ...
    @endif
    <a href="{{ route('componente.create')}}" class="btn btn-primary">Lista de docentes</a>
    ...
    <div class="uper">
        ...
        @endif
        <a href="{{ route('componente.create')}}" class="btn btn-primary">Lista de cursos</a>
        <table class="table table-striped table-bordered">
          <thead>
              <tr style="text-align: center !important;">
                <th>ID</th>
      ...
      <div>
        ...
        <div class="uper">
            ...
            @endif
            <a href="{{ route('componente.create')}}" class="btn btn-primary">Lista de materiais</a>
            <table class="table table-striped table-bordered">
              <thead>
                  <tr style="text-align: center !important;">
                    <th>ID</th>
